<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucChuyenMuc.ascx.cs" 
Inherits="WebDoanHoi_layout.administration.templateLoad.BaiViet.wucChuyenMuc" %>
            ...
            onrowcommand="GridViewChuyenMuc_RowCommand" EnableModelValidation="True">             
                <Columns>
                    ...
                    <asp:HyperLinkField DataTextField="tenchuyenmuc" HeaderText="Tên chuyên mục" 
                        DataNavigateUrlFields="machuyenmuc" 
