<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucHoatDong.ascx.cs" Inherits="WebDoanHoi_layout.wuc.wucHoatDong" %>
<div style="text-align:center;">
<div class="section-title" style="line-height:20px;">
            ...
            GridLines="None">             
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ThoiGianBatDauDangKy" 
                        HeaderText="Thời gian bắt đầu đăng ký" DataFormatString="{0:g}"/>
                    <asp:BoundField DataField="ThoiGianKetThucDangKy" 
                        HeaderText="Thời gian kết thúc đăng ký" DataFormatString="{0:g}"/>
                </Columns>
