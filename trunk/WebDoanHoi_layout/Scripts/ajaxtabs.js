...
function ddajaxtabs(tabinterfaceid, contentdivid){
	...
	this.hottabspositions=[] //Array to store position of tabs that have a "rel" attr defined, 
...
ddajaxtabs.prototype={
	...
	init:function(automodeperiod){
		var persistedtab=ddajaxtabs.getCookie(this.tabinterfaceid) //get position of persisted tab (
