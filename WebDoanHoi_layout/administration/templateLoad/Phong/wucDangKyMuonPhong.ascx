...
<div class="section-title">
    ...
    <asp:GridView ID="GridViewDangKyMuonPhong" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ngaysudung" HeaderText="Ngày Mượn"/>
                  ...
                  <asp:TemplateField HeaderText="Xóa" >
                   <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Xoa" CommandArgument='<%#Eval("madangky") %>' OnClientClick="delete_onclick()">Xóa</asp:LinkButton>
                   </ItemTemplate>                   
                </asp:TemplateField>
